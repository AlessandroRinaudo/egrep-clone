...
public class CompleteAutomaton {
  ...
  public static boolean regexValidator(String wordToValidate, CompleteAutomaton automateDeterminise, String regEx) {
    ...
    for (int i = 0; i < word.size(); i++) {
      ...
      // isConcatenate = concatenation(word.get(j), initialLine, initialColumn,
      // finalLetters, automateRegex);
  ...
  public static boolean validatore(String wordToValidate, CompleteAutomaton automateDeterminise, String regEx) {
